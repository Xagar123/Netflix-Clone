...
class SearchViewController: UIViewController {
    ...
    private let searchController: UISearchController = {
       let controller = UISearchController(searchResultsController: SearchReasult())
        controller.searchBar.placeholder = "Search for movie & Tv show"
    ...
    private func fetchDiscoverMovie() {
        APICaller.shared.discoverMovie { result in
            switch result {
...
extension SearchViewController: UISearchResultsUpdating, SearchReasultDelegate {
    ...
    func updateSearchResults(for searchController: UISearchController) {
        ...
        guard let query = searchBar.text,
              ...
              let resultController = searchController.searchResultsController as? SearchReasult else {return }
